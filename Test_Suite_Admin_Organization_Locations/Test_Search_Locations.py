...
class TestSearch(unittest.TestCase):
    ...
    def test_a_search_success_By_Name(self):
        ...
        time.sleep(1)
        browser.find_element(By.XPATH,elem.src_name).send_keys("Canadian Regional HQ")
        time.sleep(1)
    ...
    def test_b_search_success_By_City(self):
        ...
        browser.find_element(By.XPATH,elem.loc).click() #Menu Locations
        time.sleep(1)
        browser.find_element(By.XPATH,elem.src_city).send_keys("Ottawa")
        time.sleep(1)
        browser.find_element(By.XPATH,elem.src_btn).click()
        time.sleep(2)
    ...
    def test_c_search_success_By_Country(self):
        ...
        browser.find_element(By.XPATH,elem.srt_slc_country).click()
        time.sleep(1)
        browser.find_element(By.XPATH,elem.src_btn).click()
        time.sleep(2)

...
class TestAddJobTitle(unittest.TestCase):
    ...
    def test_a_add_success_job_title(self):
        ...
        time.sleep(3)
        # browser.find_element(By.XPATH, "//*[@id='app']/div[1]/div[2]/div[2]/div/div/form/div[3]/div/div[2]/div/i").click().send_keys("Test_Suite_Admin_Job_JobTilte\Final Project Batch 42.docx")
        # time.sleep(3)
